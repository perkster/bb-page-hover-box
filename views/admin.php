...
<div class="bb-phb-widget">
	...
	<div class="section display">
		...
		<p class="check">
          <input class="bb-phb-icon" id="<?php echo $this->get_field_id( 'icon' ); ?>" name="<?php echo $this->get_field_name( 'icon' ); ?>" type="checkbox" value="1" <?php checked( '1', $icon ); ?>/>
          <label style="font-weight:bold;" for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Display icon?', $this->get_widget_text_domain() ); ?></label> 
        </p>
		<p class="cf">
